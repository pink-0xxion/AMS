$(function () {
    ...
    //let savedTheme = localStorage.getItem("themeClass");
    //if (savedTheme) {
    ...
    $("#minimaltheme").on("click", function () {
        saveTheme("minimal-theme");
    });

    // === Header Colors ===
    function setHeader(headerClass) {
        removeHeaderClasses();
        $("html").addClass("color-header " + headerClass);
        saveThemeClasses();
    }
    ...
    for (let i = 1; i <= 8; i++) {
        $("#headercolor" + i).on("click", function () {
            setHeader("headercolor" + i);
        });
    }

    // === Sidebar Colors ===
    function setSidebar(sidebarClass) {
        removeSidebarClasses();
        $("html").addClass("color-sidebar " + sidebarClass);
        saveThemeClasses();
    }
    ...
    function saveThemeClasses() {
        const currentClass = $("html").attr("class");
        localStorage.setItem("themeClass", currentClass);
    }
